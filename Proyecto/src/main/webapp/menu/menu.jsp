...
<body class="sub_page">
  ...
  <div class="hero_area">
    <div class="bg-box">
      <img src="/Proyecto/assets/images/hero-bg.jpg" alt="">
    </div>
      ...
      <div class="container">
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="form-inline" action="/Proyecto/servlet-pedir" method="POST">
                      ...
                      <div>
                        ...
                        <div class="detail-box">
                          ...
                          <div class="options">
                            ...
                            <form action="/Proyecto/servlet-comida" method="POST">
                        ...
                        <div>
                          ...
                          <div class="detail-box">
                            ...
                            <div class="options">
                              ...
                              <form action="/Proyecto/servlet-postre" method="POST">
                          ...
                          <div>
                            ...
                            <div class="detail-box">
                              ...
                              <div class="options">
                                ...
                                <form action="/Proyecto/servlet-bebida" method="POST">
  ...
  <!-- jQery -->
  <script src="/Proyecto/assets/js/jquery-3.4.1.min.js"></script>
  <!-- popper js -->
  <script src="https://cdn.jsdelivr.net/npm/popper.js@1.16.0/dist/umd/popper.min.js" integrity="sha384-Q6E9RHvbIyZFJoft+2mJbHaEWldlvI9IOYy5n3zV9zzTtmI3UksdQRVvoxMfooAo" crossorigin="anonymous">
  </script>
  <!-- bootstrap js -->
  <script src="/Proyecto/assets/js/bootstrap.js"></script>
  <!-- owl slider -->
  ...
  <!-- custom js -->
  <script src="/Proyecto/assets/js/custom.js"></script>
  <!-- Google Map -->

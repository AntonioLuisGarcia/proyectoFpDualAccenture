...
<head>
  ...
  <!-- <link rel="shortcut icon" href="/Proyecto/images/favicon.png" type=""> -->

  <title> Feane </title>

  <!-- bootstrap core css -->
  <link rel="stylesheet" type="text/css" href="/Proyecto/css/bootstrap.css" />
  ...
  <!-- font awesome style -->
  <link href="/Proyecto/css/font-awesome.min.css" rel="stylesheet" />

  <!-- Custom styles for this template -->
  <link href="/Proyecto/css/style.css" rel="stylesheet" />
  <!-- responsive style -->
  <link href="/Proyecto/css/responsive.css" rel="stylesheet" />
...
<body class="sub_page">
  ...
  <div class="hero_area">
    <div class="bg-box">
      <img src="/Proyecto/images/hero-bg.jpg" alt="">
    </div>
  ...
  <!-- custom js -->
  <script src="/Proyecto/js/custom.js"></script>
  <!-- Google Map -->
